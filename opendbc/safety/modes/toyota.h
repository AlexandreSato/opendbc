...
#define TOYOTA_COMMON_RX_CHECKS(lta)                                                                          \
  ...
  {.msg = {{0x1D3, 0, 8, .ignore_counter = true, .ignore_quality_flag = true, .frequency = 33U}, { 0 }, { 0 }}}, /* MADS Cruise Main */    \
  {.msg = {{0x412, 2, 8, .ignore_checksum = true, .ignore_counter = true, .ignore_quality_flag = true, .frequency = 01U}, { 0 }, { 0 }}}, /* MADS LKAS Button */ \
